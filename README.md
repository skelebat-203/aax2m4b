# How to convert AAX2M4B (Ubuntu‑based Distros)
This document explains how to set up an Ubuntu‑based system to use the `aax2m4b_batch.sh` script to convert Audible `.aax` audiobooks into `.m4b` files, with cleaned metadata and sane filenames.  It may work for other systems, but I don't have thos. So, I do not know.  Follow these steps to:
- Download the audiobooks
- setup your environment to run the script
- run the script

## Table of Contents
### [[How to convert AAX2M4B (Ubuntu‑based Distros)#Document notes|Document notes]]

### [[How to convert AAX2M4B (Ubuntu‑based Distros)#System Setup|System Setup]]:
...
### [[How to convert AAX2M4B (Ubuntu‑based Distros)#Prepare and run conversion script|Prepare and run conversion script]]
...
### [[How to convert AAX2M4B (Ubuntu‑based Distros)#Basic Troubleshooting|Basic Troubleshooting]]
...
- [[How to convert AAX2M4B (Ubuntu‑based Distros)#System Setup|System Setup]] steps take place primarily in the Terminal app. 
...
1. **ACT**    
    - Replace `1abc2345` with your own 8‑character activation bytes from [[How to convert AAX2M4B (Ubuntu‑based Distros)#5. Get Your Activation Bytes|System Setup - Get Your Activation Bytes]].
